...
For a combined Milestone 2 + Milestone 3 results summary and paper-writing guide, see:
...
## Optional: One-click dashboard runner

You can run all steps and verify artifacts from a single dashboard:
...
Dashboard features:
- single-click full pipeline run
- per-step run controls
- artifact readiness table
- base-vs-adapted metrics preview
- retrieval preview
- final ZIP builder + download button (checks required paper/demo files first)
