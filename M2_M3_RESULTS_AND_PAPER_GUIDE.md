...
## 3) Milestone 2 results (from submission_m2)
...
```bash
.venv/bin/python training_code/pdf_to_jsonl.py --mode paragraph --min_chars 200
.venv/bin/python training_code/train_tokenizer.py
.venv/bin/python training_code/tokenizer_diagnostics.py
.venv/bin/python training_code/retrieval/run_retrieval_demo.py
.venv/bin/python training_code/smoke_test.py
.venv/bin/python training_code/base_vs_peft.py
.venv/bin/python training_code/generate_m3_plots.py
.venv/bin/streamlit run training_code/m3_dashboard.py
```
